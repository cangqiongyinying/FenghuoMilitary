...
public class YizhongguoFragmen extends BaseFragment implements IOKCallBack,PullToRefreshBase.OnRefreshListener2{
    ...
    public static final String ADRESSURL="http://if.fenghuo001.com/api1.3/topic.php?code=recdchantopic&id=14";
    ...
    public YizhongguoFragmen() {
        // Required empty public constructor
    }

    public static YizhongguoFragmen newInstance() {
        YizhongguoFragmen fragment = new YizhongguoFragmen();
        return fragment;
    }

    public static YizhongguoFragmen newInstance(String param1, String param2) {
        YizhongguoFragmen fragment = new YizhongguoFragmen();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_yizhongguo, container, false);
        putorefresh=(PullToRefreshListView)view.findViewById(R.id.yizhongguofragment_putorefreshlistview);
