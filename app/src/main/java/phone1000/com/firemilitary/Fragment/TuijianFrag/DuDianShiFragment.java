...
public class DuDianShiFragment extends BaseFragment implements IOKCallBack,PullToRefreshBase.OnRefreshListener2 {
    ...
    public static final String ADRESSURL="http://if.fenghuo001.com/api1.3/topic.php?code=recdchantopic&id=10";
    ...
    public DuDianShiFragment() {
        // Required empty public constructor
    }

    public static DuDianShiFragment newInstance() {
        DuDianShiFragment fragment = new DuDianShiFragment();
        return fragment;
    }

    public static DuDianShiFragment newInstance(String param1, String param2) {
        DuDianShiFragment fragment = new DuDianShiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_du_dian_shi, container, false);
        putorefresh=(PullToRefreshListView)view.findViewById(R.id.dudianshifragment_putorefreshlistview);
