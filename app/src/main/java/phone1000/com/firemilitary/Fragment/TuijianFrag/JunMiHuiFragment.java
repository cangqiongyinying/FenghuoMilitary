...
public class JunMiHuiFragment extends BaseFragment implements IOKCallBack,PullToRefreshBase.OnRefreshListener2{
    public static final String ADRESSURL="http://if.fenghuo001.com/api1.3/topic.php?code=recdchantopic&id=19";
    ...
    public JunMiHuiFragment() {
        // Required empty public constructor
    }

    public static JunMiHuiFragment newInstance() {
        JunMiHuiFragment fragment = new JunMiHuiFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_jun_mi_hui, container, false);
        putorefresh=(PullToRefreshListView)view.findViewById(R.id.junmihuifragment_putorefreshlistview);
