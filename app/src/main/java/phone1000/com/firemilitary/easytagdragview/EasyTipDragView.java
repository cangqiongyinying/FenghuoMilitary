package phone1000.com.firemilitary.easytagdragview;
...
import phone1000.com.firemilitary.easytagdragview.adapter.AbsTipAdapter;
import phone1000.com.firemilitary.easytagdragview.adapter.AddTipAdapter;
import phone1000.com.firemilitary.easytagdragview.adapter.DragTipAdapter;
import phone1000.com.firemilitary.easytagdragview.bean.Tip;
import phone1000.com.firemilitary.easytagdragview.widget.DragDropGirdView;
...
public class EasyTipDragView extends RelativeLayout implements AbsTipAdapter.DragDropListener, TipItemView.OnDeleteClickListener,View.OnClickListener{
    ...
    private void initView(){
        ...
        addTipAdapter = new AddTipAdapter(getContext());
        //加载view
        LayoutInflater layoutInflater = LayoutInflater.from(getContext());
        View view  = layoutInflater.inflate(R.layout.view_easytagdrag,this);
        ...
        addGridView.setSelector(new ColorDrawable(Color.TRANSPARENT));
