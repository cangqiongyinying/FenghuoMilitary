 ...
 */
package phone1000.com.firemilitary.easytagdragview.widget;
...
public class TipItemView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        image=(ImageView)findViewById(R.id.tagview_titleimage);
    ...
    public void renderData(Tip entity) {
        ...
        if (entity != null && entity != AbsTipAdapter.BLANK_ENTRY) {
            ...
            if(entity instanceof SimpleTitleTip) {
                ...
                Picasso.with(getContext()).load(((SimpleTitleTip) mIDragEntity).getImg()).into(image);
            }
